...
def options(opt):
    opt.add_option('--robot_dart', type='string',
                   help='path to robot_dart', dest='robot_dart')
...
def check_robot_dart(conf):
    ...
    try:
        ...
        include_robotdart = get_directory(
            'robot_dart/robot_dart_simu.hpp', includes_check)
