...
#include "include/qd/fitness.hpp"
 ...
 * Typedefs
 **************************************************************************************************************/
 // Define typedefs for QD algorithm
...
struct Params
{
        ...
        struct pop
        {
                ...
                SFERES_CONST unsigned size = 500;
...
using Layer1 = QD::QDAlgorithm<Params>;
}
