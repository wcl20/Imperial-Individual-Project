...
#include <sferes/stat/qd_container.hpp> // All individuals in the container
#include <sferes/stat/qd_progress.hpp>  // Overall statistics
#include "include/ns/parentStat.hpp"
#include "include/ns/offspringStat.hpp"
// Modifiers
#include <sferes/modif/dummy.hpp>
// QD Algorithm
#include <sferes/qd/quality_diversity.hpp>
// QD Algorithm (Selectors)
#include "include/ns/populationBasedSelector.hpp"
...
#include "include/ns/fitness.hpp"
...
struct NSAlgorithm
{
        ...
        typedef boost::fusion::vector<
                        ...
                        stat::QdParent<phen_t, Params>,
                        stat::QdOffspring<phen_t, Params>,
                        stat::QdProgress<phen_t, Params> > stat_t;
        // Define Modifier
        typedef modif::Dummy<> modifier_t;
        // Selector (Novelty Search)
...
struct Params
{
        ...
        static int leg;
        // Define Fitness
        typedef HexaFitness<Params> fit_t;
        struct evo_float
        {
